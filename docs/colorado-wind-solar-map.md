...
- **Brutalist overlays:** semi-transparent `#111111` fill over Colorado, **white** outline (`#ffffff`), **white** solar and wind **SVG icons** (`lib/map-plant-icons.ts`, registered via `map.addImage` on symbol layers).
